...
public enum RukoruModule {
	...
	ManagementConsole(null, "マネコン", "32x32/AWS.png"), TestPortal(null, "テストポータル", "32x32/DS.png"), ClearCache(null,
			"Clear Cache", "32x32/WPF.png"), DataSpider(DSContentController.class, "DataSpider", "32x32/DS2.png"), EC2(
					EC2ContentController.class, "EC2",
					"32x32/EC2.png"), RepositoryDB(RepositoryDBContentController.class, "リポジトリDB", "32x32/DB.png"), S3(
							S3ExplorerController.class, "S3",
							"32x32/S3.png"), Taskboard(TaskboardController.class, "タスクボード", "32x32/Redmine.png");
